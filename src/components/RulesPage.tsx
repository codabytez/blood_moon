...
const ROLES = [
  ...
  },
  {
    ...
    cls: 'badge-bodyguard',
    team: 'Village',
    desc: 'Each night, protect one player from a Mafia kill. If they are attacked, you absorb the hit. You cannot protect the same player two nights in a row.',
  },
  {
    emoji: '🎱',
    label: 'Fortune Teller',
    cls: 'badge-fortuneTeller',
    team: 'Village',
    desc: "Each night, peer into the future and learn one player's exact role — more powerful than the Seer's good/evil read. Use your knowledge carefully.",
  },
  {
    emoji: '🔍',
    label: 'Player Inspector',
    cls: 'badge-playerInspector',
    team: 'Village',
    desc: 'Each night, inspect one player. You learn if they are Suspicious (Mafia or Lycan) or Clear. A binary result — simple but decisive.',
  },
  {
    emoji: '⛪',
    label: 'Priest',
    cls: 'badge-priest',
    team: 'Village',
    desc: 'On the very first night only, bless one player with divine protection. If the Mafia targets them that night, they survive. After round 1, your power fades.',
  },
  {
    emoji: '🌀',
    label: 'Spellcaster',
    cls: 'badge-spellcaster',
    team: 'Village',
    desc: 'Each night, cast a silence spell on one player. They cannot speak or vote the following day. A powerful disruptor — silence a suspect or protect a village ally.',
  },
  {
    emoji: '🧿',
    label: 'Amulet of Protection',
    cls: 'badge-amuletOfProtection',
    team: 'Village',
    desc: 'Once per game, use the amulet to shield one player from a Mafia kill. After use, the amulet is spent and you become a plain Villager.',
  },
  {
    emoji: '👁️',
    label: 'Beholder',
    cls: 'badge-beholder',
    team: 'Village',
    desc: 'At game start, you learn who the Seer is. No night action — your power is pure knowledge. Protect that secret, and protect the Seer.',
  },
  {
    emoji: '💪',
    label: 'Tough Guy',
    cls: 'badge-toughGuy',
    team: 'Village',
    desc: 'You survive the first Mafia kill — but you die automatically the following night. One reprieve. Make it count.',
  },
  {
    emoji: '🤴',
    label: 'King',
    cls: 'badge-king',
    team: 'Village',
    desc: 'Your vote counts as two. If you are eliminated by vote or by night, you get a revenge shot — just like the Hunter. A powerful target for the Mafia.',
  },
  {
    emoji: '🤢',
    label: 'Diseased',
    cls: 'badge-diseased',
    team: 'Village',
    desc: "If the Mafia kills you, they are sickened and cannot kill anyone the following night. Your death may be the village's most valuable sacrifice.",
  },
  {
    emoji: '🩸',
    label: 'Cursed',
    cls: 'badge-cursed',
    team: 'Village',
    desc: 'If the Mafia targets you at night, instead of dying you silently become Mafia. No announcement is made. Play innocent — and hope they find you.',
  },
  {
    emoji: '🕊️',
    label: 'Pacifist',
    cls: 'badge-pacifist',
    team: 'Village',
    desc: 'You cannot vote to eliminate anyone. Your vote button is hidden. Debate freely and influence others — but you will never cast a judgment.',
  },
  {
    emoji: '🤡',
    label: 'Village Idiot',
    cls: 'badge-villageIdiot',
    team: 'Village',
    desc: 'Just a villager — but with a great excuse for acting suspicious. No powers, no special role. Blend in, cause harmless chaos, or just enjoy the ride.',
  },
]
